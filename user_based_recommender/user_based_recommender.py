...
def create_user_movie_df():
    ...
    rare_movies = comment_counts[comment_counts["count"] <= 10000].index # 1000 -> 10000, title -> count
...
movies_watched = random_user_df.columns[random_user_df.notna().any()].tolist() # isnull -> notna
...
user_movie_count[user_movie_count["movie_count"] > perc].sort_values("movie_count", ascending=False).head(10)
...
corr_df = pd.DataFrame(corr_df.index, columns=["corr"])
